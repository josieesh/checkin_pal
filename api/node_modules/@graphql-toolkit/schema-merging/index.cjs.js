...
function mergeSchemas(config) {
    ...
    const resolvers = common.composeResolvers(mergeResolvers([...config.schemas.map(schema => common.extractResolversFromSchema(schema)), ...ensureResolvers(config)], config), config.resolversComposition || {});
...
function makeSchema({ resolvers, typeDefs }, config) {
    ...
    // add resolvers
    if (resolvers) {
        schema = graphqlToolsFork.addResolveFunctionsToSchema({
            schema,
            resolvers,
