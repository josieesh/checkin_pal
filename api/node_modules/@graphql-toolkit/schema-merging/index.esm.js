...
function mergeSchemas(config) {
    ...
    const resolvers = composeResolvers(mergeResolvers([...config.schemas.map(schema => extractResolversFromSchema(schema)), ...ensureResolvers(config)], config), config.resolversComposition || {});
