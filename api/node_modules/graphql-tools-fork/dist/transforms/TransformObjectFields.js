...
var TransformObjectFields = /** @class */ (function () {
    ...
    TransformObjectFields.prototype.transformFields = function (type, objectFieldTransformer) {
        var _this = this;
        var typeConfig = polyfills_1.toConfig(type);
        ...
        return new graphql_1.GraphQLObjectType(__assign(__assign({}, polyfills_1.toConfig(type)), { fields: newFields }));
    };
            ...
            _a[graphql_1.Kind.SELECTION_SET] = function (node) {
                ...
                if (parentType != null) {
                    ...
                    node.selections.forEach(function (selection) {
                        ...
                        if (transformedSelection.kind !== graphql_1.Kind.FIELD) {
