...
function healSchema(schema) {
    ...
    var healedSchema = new graphql_1.GraphQLSchema(__assign(__assign({}, polyfills_1.toConfig(schema)), { query: newQueryTypeName ? filteredTypeMap[newQueryTypeName] : undefined, mutation: newMutationTypeName
