...
function mapSchema(schema, schemaMapper) {
    ...
    return new graphql_1.GraphQLSchema(__assign(__assign({}, polyfills_1.toConfig(schema)), { query: newQueryTypeName
...
function rewireTypes(originalTypeMap, directives) {
    ...
    function rewireDirective(directive) {
        var directiveConfig = polyfills_1.toConfig(directive);
    ...
    function rewireNamedType(type) {
        if (graphql_1.isObjectType(type)) {
            var config_1 = polyfills_1.toConfig(type);
            ...
            var config_3 = polyfills_1.toConfig(type);
            ...
            var config_4 = polyfills_1.toConfig(type);
            ...
            var enumConfig = polyfills_1.toConfig(type);
            return new graphql_1.GraphQLEnumType(enumConfig);
        }
        else if (graphql_1.isScalarType(type)) {
            if (polyfills_1.isSpecifiedScalarType(type)) {
                return type;
            }
            var scalarConfig = polyfills_1.toConfig(type);
...
function pruneTypes(typeMap, directives) {
    ...
    Object.keys(typeMap).forEach(function (typeName) {
        ...
        if (graphql_1.isObjectType(namedType) ||
            (utils_1.graphqlVersion() >= 15 && graphql_1.isInterfaceType(namedType))) {
