import { GraphQLSchema, GraphQLObjectType, GraphQLObjectTypeConfig, GraphQLFieldConfigMap, GraphQLInputFieldConfigMap, GraphQLInterfaceType, GraphQLInterfaceTypeConfig, GraphQLUnionType, GraphQLUnionTypeConfig, GraphQLEnumType, GraphQLEnumTypeConfig, GraphQLScalarType, GraphQLScalarTypeConfig, GraphQLInputObjectType, GraphQLInputObjectTypeConfig, GraphQLDirective, GraphQLDirectiveConfig, GraphQLSchemaConfig } from 'graphql';
export declare function schemaToConfig(schema: GraphQLSchema): GraphQLSchemaConfig;
export declare function toConfig(schemaOrTypeOrDirective: GraphQLSchema): GraphQLSchemaConfig;
export declare function toConfig(schemaOrTypeOrDirective: GraphQLObjectTypeConfig<any, any> & {
    interfaces: Array<GraphQLInterfaceType>;
    fields: GraphQLFieldConfigMap<any, any>;
}): GraphQLObjectTypeConfig<any, any>;
export declare function toConfig(schemaOrTypeOrDirective: GraphQLInterfaceType): GraphQLInterfaceTypeConfig<any, any> & {
    fields: GraphQLFieldConfigMap<any, any>;
};
export declare function toConfig(schemaOrTypeOrDirective: GraphQLUnionType): GraphQLUnionTypeConfig<any, any> & {
    types: Array<GraphQLObjectType>;
};
export declare function toConfig(schemaOrTypeOrDirective: GraphQLEnumType): GraphQLEnumTypeConfig;
export declare function toConfig(schemaOrTypeOrDirective: GraphQLScalarType): GraphQLScalarTypeConfig<any, any>;
export declare function toConfig(schemaOrTypeOrDirective: GraphQLInputObjectType): GraphQLInputObjectTypeConfig & {
    fields: GraphQLInputFieldConfigMap;
};
export declare function toConfig(schemaOrTypeOrDirective: GraphQLDirective): GraphQLDirectiveConfig;
export declare function toConfig(schemaOrTypeOrDirective: any): any;
